...
\newcommand{\lecture}[3]{
   ...
   \framebox{
      ...
      \hbox to 6.28in {Rensselaer Polytechnic Institute \hfill CSCI-4968: ML and Optimization}
        ...
        \vspace{2mm}
         \hbox to 6.28in { {\footnotesize{\url{https://github.com/Xinshi0726/MLOPT-U9-SDP-Relxation-For-TSP}} \hfill April 2023}}
        % \vspace{2mm}
      }
   }
   \end{center}
...
Seveal real world problems can be modelled as a set of linear contraints, making linear programming a ubiquious construct.
...
We are able to find solutions to a linear program in reasonable time.

% Not only can solutions can be found, but they can also be found quite quickly.
% https://arxiv.org/abs/1810.07896
Semidefinite programming (SDP) expands on the ideas used within linear programming and generalizes them so that they can be applied to even more cases.
...
The final $\mathbf{X}$ matrix is a probability matrix. As such, for an edge with a high value, 
it can be intrpreted as a being a high probability of being an edge in the Hamiltonian cycle. 
Thus, we can set a threshold. For probabilites higher than the threshold, we say it's part of
...
\end{figure}
We find that it is easy to find example that will break the Hamiltonian cycle, but it does lead
to a visualization. 
...
\item \url{https://www.uit.edu.mm/storage/2020/09/WWM-2.pdf}
\item \url{https://www.cs.princeton.edu/~arora/pubs/mw-focs.pdf}
\item \url{https://dl.acm.org/doi/pdf/10.1145/2184319.2184343}
\item \url{https://www.cs.princeton.edu/~arora/pubs/mw-focs.pdf}
\item \url{https://arxiv.org/pdf/1401.3409.pdf}
\item \url{https://dl.acm.org/doi/pdf/10.1145/2184319.2184343}
\end{itemize}
